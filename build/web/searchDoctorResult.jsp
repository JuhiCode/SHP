<%-- 
    Document   : searchDoctorResult
    Created on : Mar 13, 2017, 12:12:39 PM
    Author     : sukhpreet
--%>
                                ...
                                <div class="container">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-collapse">
                                        ...
                                        <ul class="nav navbar-nav navbar-right">
                                            <li><a class="" href="loginPage.jsp">LOGOUT</a></li>
                                        </ul>
                                    </div>
                                ...
                                <fieldset class="row1">
                                    ...
                                    <table border="1">
                                        <tr style="color: #066A75" style="border: #066A75" >
                                            ...
                                            <td style="color: #066A75" style="border: #066A75">Clinic Address</td>
                                            <td style="color: #066A75" style="border: #066A75">Phone number</td>
                                            <td style="color: #066A75" style="border: #066A75">Specialization</td>
                                             <td style="color: #066A75" style="border: #066A75">Availability Hour</td>
                                        </tr>
                                        <tr></tr>
                                        <%
